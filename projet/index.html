    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div id="divheader">
                    <a href="login.php"><button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"
                            class="btn btn-outline-success">Enseignant</button></a>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 py-3 py-md-0">
                        <div class="card">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3174.7641203914186!2d5.0381952040218145!3d36.75026264845937!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x128d3367dd909473%3A0xb5a389343ac0ce10!2sUniversit%C3%A9%20Abderrahmane%20Mira%20de%20B%C3%A9jaia!5e0!3m2!1sfr!2sdz!4v1709997391750!5m2!1sfr!2sdz"
                    ...
                    <div class="col-md-6 py-3 py-md-0">
                        <form action="#">
                            ...
                            <input type="text" class="form-control" placeholder="Name" required id="name"
                                name="user_name"><br>
                            <input type="text" class="form-control" placeholder="Email" required id="mail"
                                name="user_email"><br>
                            <input type="text" class="form-control" placeholder="Objet" required id="proj"
                                name="user_project"><br>
                            <textarea class="form-control" rows="5" name="text" placeholder="Message"
                                name="user_message" id="mess"></textarea>
